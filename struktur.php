    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                <img src="admin/new_images/struktur/<?php echo htmlspecialchars($struktur['image']); ?>" class="custom-text-box-image img-fluid" alt="">
            </div>

            <div class="col-lg-6 col-12">
                <div class="custom-text-box">
                    <h2 class="mb-2"><?php echo htmlspecialchars($struktur['title']); ?></h2>

                    <h5 class="mb-3"><?php echo htmlspecialchars($struktur['subtitle']); ?></h5>

                    <p class="mb-0"><?php echo htmlspecialchars($struktur['description']); ?></p>
                </div>
            </div>
