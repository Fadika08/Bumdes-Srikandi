...
<head>
    ...
    <title>Detail UMKM - <?php echo $umkm['nama']; ?></title>
...
<div class="umkm-detail">
    ...
    <img src="admin/new_images/umkm/<?php echo $umkm['gambar']; ?>" alt="Gambar UMKM">
    ...
    <?php if($umkm['link_website']) { ?>
        <a href="<?php echo $umkm['link_website']; ?>" target="_blank">Contact / Kunjungi Website</a>
    <?php } ?>
</div>


<div class="button-container">
    <a href="UMKM.php"><button type="button" class="btn btn-primary">Kembali ke Daftar UMKM</button></a>
</div>
</body>
</html>
